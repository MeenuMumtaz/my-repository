...
Your system must meet the following software and hardware requirements before you install ownCloud in your system environment.
...
3. Install ownCloud using the instructions provided on the Download page.   
